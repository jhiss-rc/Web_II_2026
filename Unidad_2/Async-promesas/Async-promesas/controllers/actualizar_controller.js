...
const obInfo = async() =>{
    ...
    try{
        const perfil = await clientService.cliente(id); // se espera a que se devuelva el producto con el id recuperado
...
formulario.addEventListener("submit", (evento) => {
    ...
    clientService.actualizarCliente(id, nombre, email) // el id solo s eusa para saber a quien llamar
    .then(() =>{
